public class CalificacionesEstudiantes{
    ...
    public static void encontrarMejorEstudiante(String[] estudiantes, double[][] notas) {
        ...
        System.out.println("\nEl mejor estudiante es " + estudiantes[mejorIndice] + " con un promedio de " + mejorPromedio);
    }
    ...
    public static void encontrarMejorMateria(String[] materias, double[][] notas) {
        ...
        System.out.println("\nLa materia con el promedio más alto es " + materias[mejorIndice] + " con un promedio de " + mejorPromedio);
    }
}
